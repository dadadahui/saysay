          ...
          <ul>
            <li v-for = "video in hotVideos" class="item">
              ...
              <div class="video">
                ...
                <div class="thumb">
                  <div class="like" @click="like(video)">{{video.likeCount}}</div>
                  <div class="dislike" @click="dislike(video)">{{video.dislikeCount}}</div>
                </div>
...
<script type="text/ecmascript-6">
  ...
  export default{
      ...
      created(){
        this.$http.get('http://localhost:9099/api/videos/hot').then((response)=>{

          this.hotVideos = response.data;
        });
        this.$http.get('http://localhost:9099/api/videos/hot').then((response)=>{
